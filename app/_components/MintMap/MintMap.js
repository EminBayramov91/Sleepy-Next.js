    ...
    return (
        <div className={styles.mintMap}>
            <div className={styles.mintMapTop}>
                <h1>MINTMAP</h1>
                <p>
                    Progression of our minting will showcase below in phases how we will begin using the funding to grow
                    our company, bring in new users, and give back to our community.
                </p>
            </div>
